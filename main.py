...
# CRYSTAL
c = Crystal(d=0.384031, D=2.4, r=38, loc=[5.627693772801094, 0, 29.46742375572686], rc=0)

# SOURCE
# s = st.generate_eliptical_source([0.02, 0.02], 70)
# s = [Source(loc=[0, 0, 0], wavelength=0.377207, intensity=1000, number=10000)]
s = [Source(loc=[0, 0, 0], wavelength=0.377207, photon_count=1000, number=100000)]

# DETECTORS
d = Detector(dim=[1, 1], loc=[15.367355795595522, 0, -21.530864290851103], res=50)
