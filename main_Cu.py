...
s = Source(loc=[0, 0, 0], wavelength=tl.ang_from_kev(8.0478), intensity=1000, number=100000)
d = Detector(dim=[1, 1], loc=[15.344294488940394, 0.0, -21.53076717546531], res=5)
dm = Detector(dim=[1, 1], loc=[14.870837373296506, 0.0, -19.04785549616726], res=5)
ds = Detector(dim=[1, 1], loc=[15.81775160458428, 0.0, -24.013678854763363], res=5)
